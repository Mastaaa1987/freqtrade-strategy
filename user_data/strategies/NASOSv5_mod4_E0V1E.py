...
# @E0V1E or @evilzzq edit by Mastaaa
...
class NASOSv5_mod4_E0V1E(IStrategy):
    INTERFACE_VERSION = 2
    ...
    # E0V1E added by Mastaaa
    buy_rsi_fast_32 = IntParameter(20, 70, default=buy_params['buy_rsi_fast_32'], space='buy', optimize=True)
    buy_rsi_32 = IntParameter(15, 50, default=buy_params['buy_rsi_32'], space='buy', optimize=True)
    buy_sma15_32 = DecimalParameter(0.900, 1, default=buy_params['buy_sma15_32'], decimals=3, space='buy', optimize=True)
    buy_cti_32 = DecimalParameter(-1, 1, default=buy_params['buy_cti_32'], decimals=2, space='buy', optimize=True)
    ...
    plot_config = {
        ...
        'subplots': {
            'rsi': {
                ...
                'rsi_1': {'color': 'orange'},
                'rsi_fast_1': {'color': 'red'},
                'rsi_slow_1': {'color': 'green'}
            },
            'cti': {
                'cti': {'color': 'blue'}
            },
    ...
    def normal_tf_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['rsi_fast_1'] = ta.RSI(dataframe, timeperiod=4)
        dataframe['rsi_slow_1'] = ta.RSI(dataframe, timeperiod=20)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            ...
            ['enter_long', 'enter_tag']] = (1, 'ewo_1')

        dataframe.loc[
            (
                (dataframe['rsi_fast'] < self.rsi_fast_buy.value) &
                (dataframe['close'] < (dataframe['ma_buy'] * self.low_offset_2.value)) &
        ...
        dataframe.loc[
            (
                ...
                (dataframe['volume'] > 0) &
                (dataframe['close'] < (
                    dataframe['ma_sell'] * self.high_offset.value))
            ),
            ['enter_long', 'enter_tag']] = (1, 'ewo_low')
        ...
        dataframe.loc[
            (
                ...
                (dataframe['rsi_fast_1'] < self.buy_rsi_fast_32.value) &
                (dataframe['rsi_1'] > self.buy_rsi_32.value) &
...
class NASOSv5_mod4_E0V1E_HO(NASOSv5_mod4_E0V1E):
    # Buy hyperspace params:
    buy_params = {
...
# Removed by Mastaaa
#########################################
class NASOSv5_mod4_E0V1E_PD(NASOSv5_mod4_E0V1E):
...
class NASOSv5_mod4_E0V1E_SL(NASOSv5_mod4_E0V1E):
    sell_params = {
        "pHSL": -0.178,
        "pPF_1": 0.019,
        "pPF_2": 0.065,
...
class NASOSv5_mod4_E0V1E_TrailingBuyStrat(NASOSv5_mod4_E0V1E):
